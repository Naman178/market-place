                    ...
                    @if($item)
                        <form class="erp-item-submit" id="item_form" data-url="{{route('items-store')}}" data-id="uid" data-name="name" data-email="email" data-pass="password">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group" id="billingcyclecontainer" style="display: none;">
                                    <label for="pricing_label">Billing Cycle</label>
                                    <select name="itembillingcycle" id="itembillingcycle" class="form-control itembillingcycle select2" style="width: 100%;">
                                        <option value="monthly" {{$item->pricing->billing_cycle=='monthly' ? 'selected' : ''}}>Monthly</option>
                                        <option value="quarterly" {{$item->pricing->billing_cycle=='quarterly' ? 'selected' : ''}}>Quarterly</option>
                                        <option value="yearly" {{$item->pricing->billing_cycle=='yearly' ? 'selected' : ''}}>Yearly</option>
                                        <option value="custom" {{$item->pricing->billing_cycle=='custom' ? 'selected' : ''}}>Custom</option>
                                    </select>
                                </div>
                                <div class="col-md-12 form-group" id="customBillingCycleContainer" style="display: none;">
                                    <label for="pricing_label">Custom Billing Cycle</label>
                                    <input type="text" name="custombillingcycle" id="custombillingcycle" value="{{$item->pricing->custom_cycle_days}}" placeholder="Enter Custom Billing Cycle" class="form-control">
                                </div>
                                <div class="col-md-12 col-12 form-group" id="autorenewalcontainer" style="display: none;">
                                    <label for="price_label">Auto Renewal</label>
                                    <label class="switch switch-primary me-3">
                                        <input type="checkbox" {{$item->pricing->auto_renew ? 'checked' : ''}} name="autorenewalcheckbox" id="autorenewalcheckbox">
                                        <span class="slider"></span>
                                    </label>
                                </div>
                                <div class="col-md-12 col-12 form-group" id="graceperiodcontianer" style="display: none;">
                                    <label for="price_label">Grace Period</label>
                                    <input type="text" name="graceperiod" id="graceperiod" class="form-control" value="{{$item->pricing->grace_period}}">
                                </div>
                                <div class="col-md-12 col-12 form-group" id="licensevaliditycontainer" style="display: none;">
...
<script>
    ...
    $('#itembillingcycle').change(function() {
        if ($(this).val() === 'custom') {
            $('#customBillingCycleContainer').show();
        } else {
            $('#customBillingCycleContainer').hide();
        }
    }).trigger('change');
