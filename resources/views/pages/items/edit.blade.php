...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        @if ($isshow == false && $type == 'recurring')
            <div class="addrecurringcardoption" id="addrecurringcardoption" style="display: none;">
                <div class="row mt-2">
                    <div class="col-md-12 form-group text-right">
                        <button type="button" class="btn btn-outline-primary addrecurringcardbtn" id="addrecurringcardbtn">Add more card</button>
                    </div>
                </div>
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 form-group input-file-col add-more-input">
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <button type="button" class="btn btn-info" id="add-image" data-id="recurring">Add more</button>
                                </div>
                            </div>
                            <div class="add-more-wrapper image-input-wrapper">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <form class="erp-item-submit" id="item_form" data-url="{{route('items-subitem-store')}}" data-id="uid" data-name="name" data-email="email" data-pass="password">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <h5 for="pricing_label">Pricing</h5>
                                        @if ($subproduct->fixed_price)
                                            <div class="row">
                                                ...
                                                @endphp
                                                <div class="col-md-4">
                                                    {!! Form::text('fixed_price', $subproduct->fixed_price, array('placeholder' => 'Enter fixed price','class' => 'form-control input-error price-input' , 'id' => 'item_fixed_price')) !!}
                                                    <div class="error" style="color:red;" id="fixed_price_error"></div>
                                                </div>
                                                <div class="col-md-4">
                                                    {!! Form::text('sale_price', $subproduct->sale_price, array('placeholder' => 'Enter sale price','class' => 'form-control input-error price-input' , 'id' => 'item_sale_price')) !!}
                                                    <div class="error" style="color:red;" id="sale_price_error"></div>
                                                </div>
                                                <div class="col-md-4">
                                                    {!! Form::text('gst_percentage', $subproduct->gst_percentage, array('placeholder' => 'Enter GST %','class' => 'form-control input-error price-input' , 'id' => 'item_gst_percentage')) !!}
                                                    <div class="error" style="color:red;" id="gst_percentage_error"></div>
                                                    <div class="gst-amount" id="gst_amount">GST Amount: <strong><span>{{ $gst_amount_formatted }}</span></strong></div>
                                                </div>
                                            </div>
