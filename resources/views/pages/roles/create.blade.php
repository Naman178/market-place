...
@endphp
@section('title')
    <title>{{$site["value"]["site_name"] ?? "Infinity"}} | Roles | New</title>
@endsection
@section('page-css')
...
<div class="breadcrumb">
    <div class="col-sm-12 col-md-12">
        <h4> <a href="{{route('dashboard')}}" class="text-uppercase">{{$site["value"]["site_name"] ?? "Infinity"}}</a> | <a href="{{route('roles.index')}}">Role</a> | Role New</a>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 form-group">
                        ...
                        {!! Form::text('name', null, array('placeholder' => 'Name','class' => 'form-control '.(count($errors->get('name')) > 0 ? 'is-invalid' : ''), 'id'=>'name')) !!}
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 form-group">
