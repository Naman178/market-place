<script>
    ...
    // For edit blog
    function toggleFieldsBasedOnType(sectionIndex) {
        var selectType = document.getElementById('select-type-' + sectionIndex);
        var selectedValue = selectType.value;

        // Get the field containers
        var headingField = document.querySelector('#section-' + sectionIndex + ' .heading-field');
        var descriptionField = document.querySelector('#section-' + sectionIndex + ' .description-field');
        var imageField = document.querySelector('#section-' + sectionIndex + ' .image-field');
        ...
        // Show fields based on the selected content type
        if (selectedValue === 'heading-description-image') {
            headingField.style.display = 'block';
            descriptionField.style.display = 'block';
            imageField.style.display = 'block';
        } else if (selectedValue === 'heading-image-description') {
            headingField.style.display = 'block';
            imageField.style.display = 'block';
            descriptionField.style.display = 'block';
        } else if (selectedValue === 'image-description-heading') {
            imageField.style.display = 'block';
            descriptionField.style.display = 'block';
            headingField.style.display = 'block';
        } else if (selectedValue === 'heading-description-image-description') {
            headingField.style.display = 'block';
            descriptionField.style.display = 'block';
            imageField.style.display = 'block';
        }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        // Loop through each section to initialize visibility
        document.querySelectorAll('.select-type').forEach(function (selectElement) {
            var sectionIndex = selectElement.dataset.sectionIndex;
            toggleFieldsBasedOnType(sectionIndex);

            // Add event listener to toggle content when the select value changes
    ...
    $(document).on('click', '.edit_remove_section', function() {
        var sectionId = $(this).data('section-id');
