    ...
    <tr>
        <td align="center" bgcolor="#007AC1" style="padding: 10px;">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/facebook.png') }}" alt="facebook" width="30"></a></td>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/whatsapp.png') }}" alt="whatsapp" width="30"></a></td>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/instagram.png') }}" alt="instagram" width="30"></a></td>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/twitter.png') }}" alt="twitter" width="30"></a></td>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/linkedin.png') }}" alt="linkedin" width="30"></a></td>
                    <td style="padding: 0 10px;"><a href="#"><img src="{{ url('https://market-place-main.infinty-stage.com/storage/Logo_Settings/youtube.png') }}" alt="youtube" width="30"></a></td>
                </tr>
            </table>
        </td>
    </tr>
