        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Currency Updated</h5>
                </div>
            <div class="modal-body">
                We’ve detected that you're visiting from India. Prices have been automatically converted from USD to INR for your convenience.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="popupDismiss" data-bs-dismiss="modal">Got it</button>
            </div>
            </div>
        </div>
    </div>
