...
{{-- <link rel="stylesheet" href="{{ asset('front-end/css/home-page.css') }}"> --}}
    <style>
        ...
        .order-card{
            background: linear-gradient(25.87deg, #BEE4FB 12.64%, #F6FBFF 88.17%);
