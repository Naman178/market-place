    ...
    <div class="card-body">
        ...
        <div class="row mb-1">
            <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
                <div class="cart-item-image">
                    <img src="@if (!empty($item->thumbnail_image)) {{ asset('storage/items_files/' . $item->thumbnail_image) }} @endif" alt="{{ $item->name }}" class="h-100 w-100">
                </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-8 cart-detail-product align-content-center">
                <h3 class="mt-0 mb-2">{{ $item->name }}</h3>
                <h5 class="mt-0 mb-2">INR {{ (int) $item->pricing->fixed_price }} Quantity: 1</h5>
            </div>
        </div>
        <hr>
        ...
        <div class="row mb-1">
            ...
            <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                <h5 class="mt-0 mb-2">INR {{ (int) $item->pricing->fixed_price }}</h5>
            </div>
        </div>
        <div class="row mb-1 discount_row d-none">
            ...
            <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                <h5 class="mt-0 mb-2" id="discount_amount">INR {{ (int) $item->pricing->fixed_price }}</h5>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-lg-4 col-sm-4 col-4 cart-detail-img">
            ...
            <div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
                <h5 class="mt-0 mb-2" id="final_total">INR {{ (int) $item->pricing->fixed_price }}</h5>
            </div>
        </div>
        <hr>
        ...
        <div class="tab-content" id="paymentTabContent">
            <div class="tab-pane fade show active" id="stripePaymentForm" role="tabpanel" aria-labelledby="profile-icon-pill">
                <form role="form" action="" method="post" id="stripe-for">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <button class="pink-blue-grad-button d-inline-block border-0 proced_to_pay_btn" id="stripeBtn" type="button">Proceed To Pay {{ (int) $item->pricing->fixed_price }} INR</button>
                        </div>
                    </div>
                </form>
            </div>
