    ...
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <div class="arrow-container w-70">
                ...
                <a href="#integrationCarousel" role="button" data-slide="next" id="right-arrow-btn"><span
                        class="arrow right-arrow"></span></a>
            </div>
        </div>
        <p class="integra_p mb-60">Whether you are a developer or not, our simple-to-use integrations and extensive<br>
            documentation make it easy to integrate MetalpriceAPI into your use case.</p>
                ...
                <div class="item wordpress_bg">
                    <div class="d-flex">
                        <div>
                            ...
                            <img class="wordpress_white_logo" src="front-end/images/wordpress_logo.png" alt="not found" style="margin-left:0px; left:83px;">
                        </div>
                        <div>
                ...
                <div class="item wordpress_bg">
                    <div class="d-flex">
                        <div>
                            ...
                            <img class="wordpress_white_logo" src="front-end/images/Group 1000002951.png" style="margin-left:0px; left:83px;"
                                alt="not found">
                        </div>
                        <div>
                    ...
                    <p class="intig_p">Facilisis primis vivamusnrts feugiat nibhr Consequat<span>phasellus
                            pretiu.</span></p>
                    <div class="d-flex">
                        <a href="#" class="integration_know ml-40">Know More</a>
                        <span><img class="know_arrow" src="front-end/images/blue_arrow.png" alt="not found"></span>
            ...
            <div class="col-4">
                <div class="item wordpress_bg">
                    <div class="d-flex">
                        <div>
                            <img class="round_blue_img" src="front-end/images/Ellipse 450.png" alt="not found">
                            <img class="wordpress_white_logo" src="front-end/images/wordpress_logo.png"
