    ...
    <div class="container">
        ...
        <div class="wordpress-plugin-grid">
                ...
                <div class="wordpress_plugin_bg h-100">
                    ...
                    @if (!empty($category))
                    <a href="{{ route('product.list', ['categoryOrSubcategory' => $category->id ?? null]) }}" class="know_more ml-40">Explore Products <span><img src="{{ asset('front-end/images/arrow.png') }}" alt="not found"></span></a>
                    @elseif (!empty($subcategory))
                        <a href="{{ route('product.list', ['categoryOrSubcategory' => $subcategory->id ?? null]) }}" class="know_more ml-40">Explore Products <span><img src="{{ asset('front-end/images/arrow.png') }}" alt="not found"></span></a>
                    @endif
