    ...
    <div class="container">
        ...
        <div class="wordpress-plugin-grid">
                ...
                <div class="wordpress_plugin_bg h-100">
                    ...
                    @if (!empty($category))
                        <a href="{{ route('product.list', ['category' => $category->name ?? null, 'slug' =>  Str::slug($subcategory->name ?? '')]) }}" class="know_more">Explore Products <span><img src="{{ asset('front-end/images/arrow.png') }}" alt="not found"></span></a>
                ...
                <div class="wordpress_plugin_bg h-100">
                    ...
                    <a href="{{ route('product.list', ['category' => $category->name ?? null, 'slug' =>  Str::slug($subcategory->name ?? '')]) }}" class="know_more">Explore Products <span><img src="{{ asset('front-end/images/arrow.png') }}" alt="not found"></span></a>
                    @elseif (!empty($subcategory))
                    <a href="{{ route('product.list', ['category' => $category->name ?? null, 'slug' =>  Str::slug($subcategory->name ?? '')]) }}" class="know_more ml-40">Explore Prodspan><img src="{{ asset('front-end/images/arrow.png') }}" alt="not found"></span></a>
                    @endif
                </div>
