<form class="mb-6" wire:submit="{{$method}}">
    ...
    <div>
        ...
        <textarea  class="py-2 px-2 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700" id="{{$inputId}}" rows="6" style="width: 100%;padding: 15px !important;outline: none;font-size: 16px;line-height: 26px;border-radius: 8px;margin: 15px 0 0 !important;"
