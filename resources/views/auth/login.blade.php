                            ...
                            <div class="p-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group" style="position: relative;">
                                        ...
                                        <button type="button" class="toggle-button" aria-label="Toggle Password Visibility">
                                            <!-- Eye icon SVG -->
                                           <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="eye-icon" viewBox="0 0 24 24" width="24" height="24">
